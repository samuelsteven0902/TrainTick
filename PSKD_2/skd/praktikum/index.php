<?php
    ...
    if(!isset($_SESSION["login"])){
       header("Location: ../praktikum/login.php");
       exit;
    } 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        <select class="form-select" name="role" id="">
                                            ...
                                            <option value="admin" <?php echo ($d->role =='admin')?'selected':'';?>>Admin
                                            </option>
                                            <option value="member" <?php echo ($d->role =='member')?'selected':'';?>>
                                                Member
                                            </option>
                                        </select>
                                    </div>
    ...
    <?php
        ...
        if(isset($_POST["submit"])){
         ...
         if($updateprofile){
            ...
            echo'<script>window.location="../praktikum/profile.php"</script>';
